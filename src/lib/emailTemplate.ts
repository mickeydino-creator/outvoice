// Shared visual "chrome" for every transactional email the app sends
// (invoice/quote sent, reminders, quote approval notifications) so they all
// look like one consistent, polished product instead of ad-hoc HTML.
